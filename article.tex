...
\section{Contributions\label{sec:contrib}}
    \noindent In section~\ref{sec:overview}, we have seen that we can find the neighbours of \acrshort{bs}s by combining a potential neighbouring graph and filtration criteria. This methodology gives pretty good results \cite{art_del_paq}.
    ...
    \subsection{Improvement of filtering criteria}
        ...
        \subsubsection{Distance and angle criterion}
            As seen in section~\ref{sec:overview}, after having found potential neighbours for each \acrshort{bs}, this connexions needs to be filtrated. However, this applies the same distance and angle threshold for all \acrshort{bs}s, without taking in account the difference of density.
