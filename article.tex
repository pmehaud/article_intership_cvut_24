...
\section{Introduction}
    ...
    In any case, these generic methods aren't perfectly adapted to this application as real base stations are submitted to specific limitations.
    ...
    Therefore, the outcome of the method presented will be a neighbouring graph where each node is a base station and each edge represent a neighbouring relationship between these two base stations. In [insert citation], you can see an example of neighbouring graph.

    The rest of the paper is organized as follows: Section II reviews the related works relevant to our research, providing a foundation by discussing prior studies and their limitations. In Section III, we detail the databases used in our analysis, including data sources, update frequency, and key characteristics. Section IV offers a reminder on existing methods, summarizing the methodologies previously applied to similar problems and setting the stage for our proposed approach. Section V outlines our contributions, emphasizing the novel aspects of our work and how it advances the field. In Section VI, we present the results, analyzing the performance and implications of our proposed methods. Finally, Section VII concludes the paper, summarizing key findings and suggesting directions for future research.
